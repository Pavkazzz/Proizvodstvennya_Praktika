...
begin
showmessage('Вы добавили максимум проектов');
exit;
end;
...
WordApplication1.Selection.Tables.Item(1).Cell(1,1).Range.Text:='Проект:';
WordApplication1.Selection.Tables.Item(1).Cell(2,1).Range.Text:='Премия за риск';
WordApplication1.Selection.Tables.Item(1).Cell(3,1).Range.Text:='Коэффициент дисконтирования';
WordApplication1.Selection.Tables.Item(1).Cell(4,1).Range.Text:='ЧДД';
WordApplication1.Selection.Tables.Item(1).Cell(5,1).Range.Text:='ЧТС';
WordApplication1.Selection.Tables.Item(1).Cell(6,1).Range.Text:='Ток';
WordApplication1.Selection.Tables.Item(1).Cell(7,1).Range.Text:='ИД';
WordApplication1.Selection.Tables.Item(1).Cell(8,1).Range.Text:='СР';
WordApplication1.Selection.Tables.Item(1).Cell(9,1).Range.Text:='ВНД';
for  i:=1  to lb.Items.Count  do
  begin
  DM.OpenProject(lb.Items[i-1]);
  FRisk.label25.OnClick(self);
...
WordApplication1.Selection.TypeText('График ЧДД:');
...
WordApplication1.Selection.TypeText(#13#13#13);
WordApplication1.Selection.Font.Bold:=1;
WordApplication1.Selection.TypeText('График ЧТС:');
WordApplication1.Selection.TypeText(#13);
