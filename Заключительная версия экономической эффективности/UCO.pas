...
uses UDP, UCDD, Ud,UConverter, UMain, Unit1;
...
FDper.SpeedButton7.OnClick(Self);
  ...
  begin
  chart1.Series[2].AddXY(round(StrToFloat(FDper.sg1.cells[i1,0])), round(StrToFloat(
  FDper.sg1.cells[i1,3])));

  chart1.Series[3].AddXY(round(StrToFloat(FDper.sg1.cells[i1,0])),
